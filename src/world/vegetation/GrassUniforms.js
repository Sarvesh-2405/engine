...
export function createGrassFieldUniforms() {
  ...
  const uniforms = {
    surface: {
      ...
      // Wind
      uWindStrength: { value: 0.48 },
      uWindSpeed:    { value: 1.6 },
      uWindFreq:     { value: 0.35 },
      uWindTurb:     { value: 0.35 },
      uWindLean:     { value: 0.35 },
      ...
      uLeafBottom:       { value: new THREE.Color('#1e4528') },
      uLeafTop:          { value: new THREE.Color('#6da040') },
      uLeafBrightness:   { value: 1.25 },
      uLeafGradPower:    { value: 1.0 },
      uLeafVarColor:     { value: new THREE.Color('#264c30') },
      uLeafVarStrength:  { value: 0.65 },
      uLeafVarScale:     { value: 0.30 },
      uLeafWindStrength: { value: 0.28 },
      uLeafFlutterAmp:   { value: 0.38 },
